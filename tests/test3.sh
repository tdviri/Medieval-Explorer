#!/usr/bin/env bash
# tests multiple gets and inventory
...
options=""
#bash /usercode/main.sh $options > /usercode/output.txt 2> STDERR
...
grep_opts="-i -E"
EXPECTED="\[5\] scimitar blade
\[135\] a huge rubber duck
\[365\] banner war merc
"
